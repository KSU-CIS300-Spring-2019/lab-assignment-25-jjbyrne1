    ...
    public class MinPriorityQueue<TPriority, TValue> where TPriority : IComparable<TPriority>
    {
            ...
            LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            else
            {
                ...
                if (comp < 0)
                {
                    LeftistTree<KeyValuePair<TPriority, TValue>> newLeftistTree = new LeftistTree<KeyValuePair<TPriority, TValue>>(h1.Data, h1.LeftChild, Merge(h1.RightChild, h2));
                    return newLeftistTree;
                }
                else
                {
                    LeftistTree<KeyValuePair<TPriority, TValue>> newLeftistTree = new LeftistTree<KeyValuePair<TPriority, TValue>>(h2.Data, h2.LeftChild, Merge(h2.RightChild, h1));
                    return newLeftistTree;
                }
            }
        }
        ...
        /// </summary>
        /// <returns> The element with minimum priority. </returns>
